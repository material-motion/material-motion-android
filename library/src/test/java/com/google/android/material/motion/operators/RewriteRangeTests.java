...
public class RewriteRangeTests {
  @Test
  public void testOnlyEmitsRewrittenValues() {
    ...
    property.getStream().compose(Rewrite.rewriteRange(0f, 100f, 0f, 1f))
      .subscribe(tracker);

    property.write(50f);
    property.write(75f);
    property.write(125f);
    assertThat(tracker.values).isEqualTo(Arrays.asList(0f, 0.5f, 0.75f, 1.25f));
  }
}
