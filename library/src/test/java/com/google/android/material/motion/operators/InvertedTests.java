...
public class InvertedTests {
  ...
  public void testBool() {
    ...
    ReactiveProperty<Boolean> property = ReactiveProperty.of(false);
    property.getStream().compose(Inverted.inverted())
      .subscribe(tracker);

    property.write(true);
    assertThat(tracker.values).isEqualTo(Arrays.asList(true, false));
  }
}
